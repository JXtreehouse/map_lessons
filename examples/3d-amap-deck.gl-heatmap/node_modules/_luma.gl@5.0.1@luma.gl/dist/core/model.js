...
var _object3d = require('../core/object-3d');
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* eslint quotes: ["error", "single", { "allowTemplateLiterals": true }]*/
...
var Model = /*#__PURE__*/function (_Object3D) {
  ...
  function Model(gl) {
    ...
    (0, _assert2.default)((0, _webgl.isWebGL)(gl));
    _this.gl = gl;
    _this.init(opts);
    return _this;
  }
  ...
  _createClass(Model, [{
    ...
    value: function init() {
      ...
      (0, _assert2.default)(this.drawMode !== undefined && Number.isFinite(this.vertexCount), ERR_MODEL_PARAMS);

      this.timerQueryEnabled = timerQueryEnabled && _query2.default.isSupported(this.gl, { timer: true });
    ...
    value: function _initializeProgram(_ref2) {
      ...
      if (!program) {
        ...
        var assembleResult = (0, _shadertools.assembleShaders)(this.gl, { vs: vs, fs: fs, modules: modules, defines: defines });
        ...
        if (shaderCache) {
          ...
          program = new _webgl.Program(this.gl, { vs: vs, fs: fs });
        }
    ...
    value: function setVertexCount(vertexCount) {
      (0, _assert2.default)(Number.isFinite(vertexCount));
      this.vertexCount = vertexCount;
      return this;
    }
  }, {
    ...
    value: function setInstanceCount(instanceCount) {
      (0, _assert2.default)(Number.isFinite(instanceCount));
      this.instanceCount = instanceCount;
      return this;
    }
  }, {
    ...
    value: function draw() {
      ...
      (0, _webgl.withParameters)(gl, parameters, function () {
    ...
    value: function render() {
      ...
      _utils.log.group(LOG_DRAW_PRIORITY, '>>> RENDERING MODEL ' + this.id, { collapsed: _utils.log.priority <= 2 });
      ...
      _utils.log.groupEnd(LOG_DRAW_PRIORITY, '>>> RENDERING MODEL ' + this.id);
    ...
    value: function _timerQueryStart() {
      if (this.timerQueryEnabled === true) {
        if (!this.timeElapsedQuery) {
          this.timeElapsedQuery = new _query2.default(this.gl);
        }
    ...
    value: function _timerQueryEnd() {
      if (this.timerQueryEnabled === true) {
        ...
        if (this.timeElapsedQuery.isResultAvailable()) {
          ...
          // Log stats
          _utils.log.log(LOG_DRAW_PRIORITY, 'GPU time ' + this.program.id + ': ' + this.stats.lastFrameTime + 'ms average ' + this.stats.averageFrameTime + 'ms accumulated: ' + this.stats.accumulatedFrameTime + 'ms count: ' + this.stats.profileFrameCount);
        }
      }
    }
    ...
    value: function _getAttributeEntry(attribute, location, header) {
      ...
      }, header, (0, _utils.formatValue)(value, { size: size, isInteger: isInteger }));
    }
