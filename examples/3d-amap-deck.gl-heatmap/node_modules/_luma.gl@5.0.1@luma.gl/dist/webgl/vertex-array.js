...
var VertexArray = /*#__PURE__*/function (_Resource) {
  ...
  _createClass(VertexArray, [{
    ...
    value: function isSupported(gl) {
      return (0, _context.isWebGL2)(gl) || gl.getExtension(OES_vertex_array_object);
    }
  }, {
    key: 'getDefaultArray',
  ...
  _createClass(VertexArray, [{
    ...
    value: function setElements(elements) {
      (0, _assert2.default)(!elements || elements.target === GL_ELEMENT_ARRAY_BUFFER, ERR_ELEMENTS);
    ...
    value: function setBuffer() {
      ...
      this.bind(function () {
        ...
        if (!layout.integer) {
          ...
          (0, _assert2.default)((0, _context.isWebGL2)(gl));
    ...
    value: function _getLocations(buffers) {
      ...
      for (var bufferName in buffers) {
        ...
        if (buffer && buffer.target === GL_ELEMENT_ARRAY_BUFFER) {
          (0, _assert2.default)(!elements, 'Duplicate GL.ELEMENT_ARRAY_BUFFER');
        ...
        (0, _assert2.default)(Number.isFinite(location));

        (0, _assert2.default)(!locations[location], 'Duplicate attribute for binding point ' + location);
    ...
    value: function _sortBuffersByLocation(buffers) {
      ...
      for (var bufferName in buffers) {
        ...
        (0, _assert2.default)(locations[location] === null, 'Duplicate attribute for binding point ' + location);
    ...
    value: function _getData() {
      ...
      return new Array(this.MAX_ATTRIBUTES).fill(0).map(function (_, location) {
        ...
        PARAMETERS.forEach(function (parameter) {
          result[(0, _glConstants.glKey)(parameter)] = _this5.getParameter(parameter, { location: location });
        });
        return result;
      });
    }
