  ...
  _createClass(Texture, [{
    ...
    value: function initialize() {
      ...
      if (this._isNPOT()) {
        ...
        _utils.log.warn('texture: ' + this + ' is Non-Power-Of-Two, disabling mipmaping');
        mipmaps = false;
    ...
    */
    ...
    value: function _updateForNPOT(parameters) {
      if (parameters[this.gl.TEXTURE_MIN_FILTER] === undefined) {
        _utils.log.warn('texture: ' + this + ' is Non-Power-Of-Two, forcing TEXTURE_MIN_FILTER to LINEAR');
        parameters[this.gl.TEXTURE_MIN_FILTER] = this.gl.LINEAR;
      }
      if (parameters[this.gl.TEXTURE_WRAP_S] === undefined) {
        _utils.log.warn('texture: ' + this + ' is Non-Power-Of-Two, forcing TEXTURE_WRAP_S to CLAMP_TO_EDGE');
        parameters[this.gl.TEXTURE_WRAP_S] = this.gl.CLAMP_TO_EDGE;
      }
      if (parameters[this.gl.TEXTURE_WRAP_T] === undefined) {
        _utils.log.warn('texture: ' + this + ' is Non-Power-Of-Two, forcing TEXTURE_WRAP_T to CLAMP_TO_EDGE');
        ...
        switch (pname) {
          ...
          case _glConstants2.default.TEXTURE_WRAP_T:
            if (param !== _glConstants2.default.CLAMP_TO_EDGE) {
              _utils.log.warn('texture: ' + this + ' is Non-Power-Of-Two, ' + (0, _glConstants.glKey)(pname) + ' to CLAMP_TO_EDGE');
