...
var _typedArrayUtils = require('../utils/typed-array-utils');
...
var Framebuffer = /*#__PURE__*/function (_Resource) {
  ...
  _createClass(Framebuffer, [{
    ...
    value: function isSupported(gl) {
      ...
      var supported = true;
      supported = colorBufferFloat && gl.getExtension((0, _context.isWebGL2)(gl) ? 'EXT_color_buffer_float' : 'WEBGL_color_buffer_float');
      supported = colorBufferHalfFloat && gl.getExtension((0, _context.isWebGL2)(gl) ? 'EXT_color_buffer_float' : 'EXT_color_buffer_half_float');
      return supported;
    }
  ...
  _createClass(Framebuffer, [{
    ...
    value: function resize() {
      ...
      if (this.handle === null) {
        (0, _assert2.default)(width === undefined && height === undefined);
    ...
    value: function attach(attachments) {
      ...
      for (var attachment in newAttachments) {
        ...
        (0, _assert2.default)(attachment !== 'undefined', 'Misspelled framebuffer binding point?');

        var descriptor = newAttachments[attachment];
        var object = descriptor;
        if (!object) {
          this._unattach({ attachment: attachment });
        } else if (object instanceof _renderbuffer2.default) {
    ...
    value: function clear() {
      ...
      if (color || depth || stencil) {
        (0, _clear2.clear)(this.gl, { color: color, depth: depth, stencil: stencil });
      }

      drawBuffers.forEach(function (value, drawBuffer) {
        (0, _clear2.clearBuffer)({ drawBuffer: drawBuffer, value: value });
      });
    ...
    value: function readPixels(_ref7) {
      var _ref7$x = _ref7.x,
          ...
          format = _ref7$format === undefined ? _api2.default.RGBA : _ref7$format,
          type = _ref7.type,
      ...
      if (attachment === _api2.default.COLOR_ATTACHMENT0 && this.handle === null) {
        attachment = _api2.default.FRONT;
      }
      ...
      if (!pixelArray) {
        ...
        var ArrayType = (0, _typedArrayUtils.getTypedArrayFromGLType)(type, { clamped: false });
    ...
    value: function copyToDataUrl() {
      ...
      while (height > maxHeight) {
        var _scalePixels = (0, _utils.scalePixels)({ data: data, width: width, height: height });
      ...
      (0, _utils.flipRows)({ data: data, width: width, height: height });
    ...
    value: function blit(_ref11) {
      var srcFramebuffer = _ref11.srcFramebuffer,
          ...
          filter = _ref11$filter === undefined ? _api2.default.NEAREST : _ref11$filter;
      var gl = this.gl;
    ...
    value: function log() {
      ...
      _utils.log.image({ priority: priority, message: message, image: image }, message);
      return this;
    }
    ...
    value: function _createDefaultAttachments(_ref17) {
      ...
      if (color) {
        ...
        defaultAttachments[GL_COLOR_ATTACHMENT0] = new _texture2d2.default(this.gl, {
          pixels: null, // reserves texture memory, but texels are undefined
          format: _api2.default.RGBA,
          type: _api2.default.UNSIGNED_BYTE,
          width: width,
          height: height,
          ...
          parameters: (_parameters = {}, _defineProperty(_parameters, _api2.default.TEXTURE_MIN_FILTER, _api2.default.NEAREST), _defineProperty(_parameters, _api2.default.TEXTURE_MAG_FILTER, _api2.default.NEAREST), _defineProperty(_parameters, _api2.default.TEXTURE_WRAP_S, _api2.default.CLAMP_TO_EDGE), _defineProperty(_parameters, _api2.default.TEXTURE_WRAP_T, _api2.default.CLAMP_TO_EDGE), _parameters)
        });
      }
      ...
      if (depth) {
        defaultAttachments = defaultAttachments || {};
        defaultAttachments[GL_DEPTH_ATTACHMENT] = new _renderbuffer2.default(this.gl, { format: _api2.default.DEPTH_COMPONENT16, width: width, height: height });
      }
    ...
    value: function _attachTexture(_ref20) {
      ...
      switch (texture.target) {
        ...
        default:
          (0, _assert2.default)(false, 'Illegal texture type');
      }
    ...
    value: function _setReadBuffer(gl, readBuffer) {
      if ((0, _context.isWebGL2)(gl)) {
        ...
        (0, _assert2.default)(readBuffer === GL_COLOR_ATTACHMENT0 || readBuffer === _api2.default.BACK, ERR_MULTIPLE_RENDERTARGETS);
      }
    ...
    value: function _setDrawBuffers(gl, drawBuffers) {
      if ((0, _context.isWebGL2)(gl)) {
        ...
        if (ext) {
          ...
          (0, _assert2.default)(drawBuffers.length === 1 && (drawBuffers[0] === GL_COLOR_ATTACHMENT0 || drawBuffers[0] === _api2.default.BACK), ERR_MULTIPLE_RENDERTARGETS);
        }
      }
    ...
    value: function _getAttachmentParameterFallback(pname) {
      ...
      switch (pname) {
        case _api2.default.FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER:
          // GLint
          return !caps.webgl2 ? 0 : null;
        case _api2.default.FRAMEBUFFER_ATTACHMENT_RED_SIZE: // GLint
        case _api2.default.FRAMEBUFFER_ATTACHMENT_GREEN_SIZE: // GLint
        case _api2.default.FRAMEBUFFER_ATTACHMENT_BLUE_SIZE: // GLint
        case _api2.default.FRAMEBUFFER_ATTACHMENT_ALPHA_SIZE: // GLint
        case _api2.default.FRAMEBUFFER_ATTACHMENT_DEPTH_SIZE: // GLint
        case _api2.default.FRAMEBUFFER_ATTACHMENT_STENCIL_SIZE:
          // GLint
          return !caps.webgl2 ? 8 : null;
        case _api2.default.FRAMEBUFFER_ATTACHMENT_COMPONENT_TYPE:
          // GLenum
          return !caps.webgl2 ? _api2.default.UNSIGNED_INT : null;
        case _api2.default.FRAMEBUFFER_ATTACHMENT_COLOR_ENCODING:
          return !caps.webgl2 && !caps.EXT_sRGB ? _api2.default.LINEAR : null;
        default:
          return null;
      }
    }
...
function glFormatToComponents(format) {
  switch (format) {
    case _api2.default.ALPHA:
      return 1;
    case _api2.default.RGB:
      return 3;
    case _api2.default.RGBA:
      return 4;
    default:
