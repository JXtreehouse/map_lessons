...
function withPropsReactive(MapComponent) {
  return function (_React$Component) {
    ...
    _createClass(_class, [{
      ...
      value: function reactivePropChange(nextProps) {
        ...
        list.length && list.forEach(function (key) {
          ...
          if (shouldDetectChange) {
            willReactive = _this2.deletePropChange(key, nextProps, _this2.props);
          }
          if (!willReactive) {
            return false;
          }
      ...
      key: 'deletePropChange',
      value: function deletePropChange(key, nextProps, oldProps) {
...
var APILoader = function () {
  function APILoader(_ref) {
    ...
    this.config = _extends({}, DEFAULT_CONFIG, { useAMapUI: useAMapUI });
    if (typeof window !== 'undefined') {
      if (key) {
        this.config.key = key;
